...
public class SpCallTreeFirstLevel extends ActionSupport{
	...
	public String execute() throws Exception {
		...
		System.out.println("::::sp call tree form values->projectId"+getProjectId());
		System.out.println("::::sp call tree form values->migrationMode"+getMigrationMode());
		System.out.println("::::sp call tree form values->analysisType"+getAnalysisType());
		System.out.println("::::sp call tree form values->submitMode"+getSubmitMode());
		...
		procNameList  = lSpCallTreeFirstLevelDAO.getProcNameList(getProjectId(),getAnalysisType());
		System.out.println(":::::procNameList size:::"+procNameList.size());
			...
			if("save".equalsIgnoreCase(getSubmitMode())){
				...
				lSeqNo = lSpCallTreeFirstLevelDAO.insertIdentifyPatternDetails(getProjectId(),getMigrationMode(),getAnalysisType(),getPartialSPSelected(),pCreatedBy,"SP_CALL_TREE_FIRST_LEVEL");
				setSeqNo(lSeqNo);
