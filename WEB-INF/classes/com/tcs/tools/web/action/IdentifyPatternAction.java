...
public class IdentifyPatternAction extends ActionSupport /*implements ServletRequestAware,ServletResponseAware */ {
	...
	private List<IdentifyPatternDTO>  procNameListT ;
...
//	if(getAnalysisType() == null || "".equals(getAnalysisType())){
	...
	if(getAnalysisType().equalsIgnoreCase("TARGET")){
	procNameList  = lIdentifyPatternDAO.getProcNameList(getProjectId(),"TARGET");}
	/*if(procNameListT!=null){
		
		setAnalysisType("TARGET");
		System.out.println(":::::procNameList target size:::"+procNameListT);
		System.out.println(":::::AM:::"+getAnalysisType());
	}*/
	//System.out.println(":::::procNameList target size:::"+procNameListT.size());
	if(getAnalysisType().equalsIgnoreCase("SOURCE")){
		procNameList  = lIdentifyPatternDAO.getProcNameList(getProjectId(),"SOURCE");}
	/*if(procNameList!=null){
		setAnalysisType("SOURCE");
		System.out.println(":::::procNameList  size:::"+procNameList);
		System.out.println(":::::AM:::"+getAnalysisType());
	}*/
	...
	//System.out.println(":::::procNameList size:::"+procNameList.size());
		...
		if("save".equalsIgnoreCase(getSubmitMode())){
			...
			lSeqNo = lIdentifyPatternDAO.insertIdentifyPatternDetails(getProjectId(),getMigrationMode(),getAnalysisType(),getPartialSPSelected(),pCreatedBy,"IDENTIFY_PATTERN_REPORT");
			setSeqNo(lSeqNo);
			...
			if(procNameList!=null){
				...
				setAnalysisType("SOURCE");
				System.out.println(":::::procNameList target size:::"+procNameList);
				System.out.println(":::::AM:::"+getAnalysisType());
	...
	public List<IdentifyPatternDTO> getProcNameListT() {
		return procNameListT;
	}



	public void setProcNameListT(List<IdentifyPatternDTO> procNameListT) {
		this.procNameListT = procNameListT;
	}
