...
public class ViewManualModificationAction extends ActionSupport{
	...
	ViewManualModificationDAO lViewManualModificationDAO=new ViewManualModificationDAO();
	
	
	public String execute() throws Exception {
		
		System.out.println(":::identify patterns action manual modification::::"+getSubmitMode());
		System.out.println("::::manual modification form values->projectId"+getProjectId());
		System.out.println("::::manual modification form values->migrationMode"+getMigrationMode());
		System.out.println("::::manual modification form values->analysisType"+getAnalysisType());
		System.out.println("::::manual modification form values->submitMode"+getSubmitMode());
		...
		procNameList  = lViewManualModificationDAO.getProcNameList(getProjectId(),getAnalysisType());
		//System.out.println(":::::procNameList size:::"+procNameList.size());
			...
			if("save".equalsIgnoreCase(getSubmitMode())){
				...
				lSeqNo = lViewManualModificationDAO.insertIdentifyPatternDetails(getProjectId(),getMigrationMode(),getAnalysisType(),getPartialSPSelected(),pCreatedBy,"MANUAL_MODIFICATION_LOG");
				setSeqNo(lSeqNo);
