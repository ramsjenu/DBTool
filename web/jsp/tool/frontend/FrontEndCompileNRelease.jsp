...
<script>
	 ...
	 function openPopUpReport(){
		 ...
		 document.form1.submitMode.value = "feGenerateOutput";		
			document.form1.action='<%=filePath%>'+"/tool/frontEndComplieNRelease.action";
			document.form1.submit();
		<%-- window.open ("<%=filePath%>/tool/frontEndComplieNRelease.action?submitMode=feGenerateOutput&projectId=<%=projectId%>&analysisType=<%=analysisType%>&seqNo=<%=seqNo%>&migrationMode=<%=migrationMode%>","repot1","menubar=0,resizable=1,scrollbars=1,width=850,height=600"); --%>
	 }
				...
				<td width="60%" valign="top">
					...
					<table width="100%" border=0 cellspacing="2" cellpadding="2"
						...
						<tr class="pageheadernoWidth">
							<td colspan="2">&nbsp;&nbsp;&nbsp;Compile and Release</td>
						</tr>
						...
						<tr>
							<td colspan="2" align="center"><div id="report1_link"
									...
									&nbsp; <a class="moreproject2" style="cursor: hand"
										onclick="openPopUpReport();"><u><font color="blue">Download Migrated Source Code</font></u> </a>
								</div></td>
						</tr>
