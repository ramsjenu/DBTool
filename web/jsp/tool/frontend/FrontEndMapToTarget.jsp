...
<script>
	 ...
	 function openPopUpReport(){
		window.open ("<%=filePath%>/tool/feCodeMigrationReports.action?submitMode=feMapToTargetReport&projectId=<%=projectId%>&analysisType=<%=analysisType%>&seqNo=<%=seqNo%>&migrationMode=<%=migrationMode%>","repot1","menubar=0,resizable=1,scrollbars=1,width=850,height=600");
	 }
	...
	function changeProjectName(){
		...
		document.form1.action='<%=filePath%>'+"/tool/frontEndMapToTarget.action";
						...
						<tr>
							<td colspan="2" align="center"><div id="report1_link"
									...
									&nbsp; <a class="moreproject2" style="cursor: hand"
										onclick="openPopUpReport();"><u><font color="blue">Dynamic SQL Source-Target
												Mapping Report</font></u> </a>
								</div></td>
						</tr>
