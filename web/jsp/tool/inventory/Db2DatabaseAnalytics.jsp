...
<%
	 ...
	 HashMap inventoryMap = new HashMap();
		...
		String schemaName = "";
		if(request.getAttribute("schemaName") != null){
			schemaName = (String)request.getAttribute("schemaName");
		}
		
	%>
	<script>
	function downloadFile(paramValue,paramSubmitMode){
		if( paramSubmitMode == "downloadReport" || paramSubmitMode =="downloadConsolidatedReport"||paramSubmitMode =="download"){
		...
		document.form1.action='<%=filePath%>'+"/tool/Db2DatabaseAnalytics.action?submitMode="+paramSubmitMode+"&type="+paramValue ;
	...
	function changeProject(){
		...
		document.form1.action='<%=filePath%>'+"/tool/Db2DatabaseAnalytics.action?submitMode=changeProject";
		document.form1.submit();
				...
				<td width="60%" valign="top">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2"
						...
						<tr class="pageheadernoWidth">
							<td colspan="2">&nbsp;&nbsp;&nbsp;Target Database Analytics</td>
						</tr>
						...
						<tr align="left">
							<td colspan="2" class="labelText2"><font size="-1">Schema
									being used:</font>&nbsp;<font color="brown"><%=schemaName %></font></td>
						</tr>
						<%} %>
						...
						<tr align="left">
							<td colspan="2" class="labelText2"><font size="-1">Database
									being used:</font>&nbsp;<font color="brown"><%=dbName %></font></td>
						</tr>
						<%} %>
