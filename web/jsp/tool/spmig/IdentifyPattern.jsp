...
<script>
	...
	function changeProjectName(){
		...
		document.form1.action='<%=filePath%>'+"/tool/identifyPattern.action?";
					...
					<table width="100%" border=0 cellspacing="2" cellpadding="2"
						...
						<tr height="25%">
							...
							<td nowrap width="75%"><select class="input1"
								name="analysisType" onChange="return changeProjectName();">
									<option>--Select--</option>
									<option
										<%if("SOURCE".equalsIgnoreCase(analysisType)){out.println("selected");} %>
										value="SOURCE">Source</option>
									<option
										<%if("TARGET".equalsIgnoreCase(analysisType)){out.println("selected");} %>
									...
									%>
										<tr class="input">
											<td width="1%"><input type="checkbox"
												name="partialSP<%=i%>" id="partialSP<%=i%>"
						...
						<tr>
							<td colspan="2" align="center"><div id="report1_link"
									...
									<a class="moreproject2" style="cursor: hand"
										onclick="openPopUpReport();"><u><font color="blue">Stored
												Procedure Pattern Report</font></u> </a>
								</div></td>
						</tr>
