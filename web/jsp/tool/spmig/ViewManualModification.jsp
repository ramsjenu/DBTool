...
<script>
	var lMatchedSPCount=0;
	 ...
	 function openPopUpReport(){
		window.open ("<%=filePath%>/tool/spMigrationReports.action?submitMode=manualModificationLogReport&projectId=<%=projectId%>&migrationMode=<%=migrationMode%>&seqNo=<%=seqNo%>","detailedSummaryReport","scrollbars=1,menubar=0,resizable=1,width=850,height=500");
	 }
	...
	function changeProjectName(){
		...
		document.form1.action='<%=filePath%>'+"/tool/viewManualModification.action?";
				...
				<td width="60%" valign="top">
					...
					<table width="100%" border=0 cellspacing="2" cellpadding="2"
						...
						<tr class="pageheadernoWidth">
							<td colspan="2">&nbsp;&nbsp;&nbsp;Manual Modification Log</td>
						</tr>
						...
						<tr>
							<td colspan="2" align="center"><div id="report1_link"
									...
									&nbsp; <a class="moreproject2" style="cursor: hand"
										onclick="openPopUpReport();"><u><font color="blue">Manual
												Modification Log Report</font></u> </a> </br> </br>
