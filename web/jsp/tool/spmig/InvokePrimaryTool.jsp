...
<script>
	...
	function downloadMigratedFiles(){
		
		if(document.form1.projectId.value == ""){
			alert("Please Select a project...");
			return false;
		}
		document.form1.submitMode.value= "downloadSource";
		document.form1.action='<%=filePath%>'+"/tool/invokePrimaryTool.action?seqNo="+'<%=seqNo%>';
	...
	function changeProjectName(){
		...
		document.form1.action='<%=filePath%>'+"/tool/invokePrimaryTool.action?submitMode=init";
		document.form1.submit();
	} 
	...
	function submitIdentifyPattern(){
		...
		/* if(document.form1.analysisType.value == ""){
			alert("Please enter a pattern to identify.");
		...
		var confRet = confirm("Are u shure to invoke sqlways , it might take time based on the file size of the SP selected...");
		if(confRet == false){
			return false;
		}
		...
		document.form1.action='<%=filePath%>'+"/tool/invokePrimaryTool.action";
		document.form1.submit();
				...
				<td width="60%" valign="top">
					...
					<table width="100%" border=0 cellspacing="2" cellpadding="2"
						...
						<tr class="pageheadernoWidth">
							<td colspan="2">&nbsp;&nbsp;&nbsp;<!-- Invoke Primary Tool -->
								Download Target Stored Procedures
							</td>
						</tr>
						...
						<td colspan="1" align="left"><input type="button" class="moreproject" value="Submit" id="pageSubmit" onclick="return submitIdentifyPattern();"> &nbsp;&nbsp;&nbsp;<input id="pageNext" type="button" class="moreproject" value="Proceed with Invoking Primary Tool" onclick="return identifyPatternNext();"  style="display:none" disabled> </td> 
					</tr> -->
						<tr>
							<td colspan="2" align="center">&nbsp;</td>
						</tr>
						...
						<tr>
							<td colspan="2" align="center"><div id="report1_link"
									...
									&nbsp; <a style="visiblity: hidden; display: none;"
										class="moreproject2" style="cursor:hand"
										onclick="openPopUpReport();"><u><font color="blue">Click
												Here to open the Stored Procedure Pattern Report</font></u> </a>
								</div></td>
						</tr>
						<tr>
							<td colspan="2" align="center">&nbsp; <a
								class="moreproject2" style="cursor: hand"
								onclick="downloadMigratedFiles();"><u><font color="blue">Download
											Complete Migrated Source</font></u> </a>
							</td>
						</tr>
